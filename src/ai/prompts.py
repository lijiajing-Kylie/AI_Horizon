...
一.五、培训相关性判断（独立维度，与 relevant 无关）

请额外判断内容是否属于“值得企业培训负责人阅读的培训方法论内容”，输出 training_relevance（0-5）。读者是负责组织培训的人（培训中心、HR、学习与发展部门、培训经理），不是想报名课程的学员。需同时满足三条标准：

一、培训内容占比：正文中与“培训方法论、组织架构与人才管理、员工培训、学习与发展、企业大学、人才培养”直接相关的内容必须占一半以上（>= 50%），才算培训主体内容。
二、拒绝广告宣传：课程招生、训练营招募、卖课推广、报名/扫码引导等以“让人报名”为目的的内容不算——即使它推销的是培训课程。促销味浓的标题（“我下场了”“涨薪”“倒计时”“错过等一年”）是典型广告信号。
三、方法论层面且有革新意义的创新方法：内容必须落到“怎么做”的方法论层面，提出可落地的新方法、新机制、新做法——尤其是在组织架构管理、员工培训/学习发展方式上的创新（如培训体系设计、岗位能力模型、讲师/课程运营机制、组织学习机制、考核激励、数字化学习方式等）。只有观点、心得、行业观察、案例故事这类“引人思考”但给不出可借鉴做法的内容不算。

training_relevance = 5：正文 50%+ 培训相关，且提出有革新意义、可落地的培训方法论/机制（组织架构管理或员工培训上的创新做法），培训负责人能直接借鉴落地。
training_relevance = 4：正文 50%+ 培训相关，提供明确可借鉴的培训方法/机制/组织实践，对培训负责人有实际价值，且不是纯广告。
training_relevance = 3：培训相关，但只停留在“引人思考”的观点/经验层面、缺少可落地方法论；或培训占比不足一半。
training_relevance = 2：课程招生/训练营招募等广告宣传，或以推广某次培训/课程报名为主。
training_relevance = 1：基本与培训无关，仅零星提及。
training_relevance = 0：与培训完全无关。

注意：
- 它与 relevant、ai_score 相互独立：即使 relevant = false，只要正文 50%+ 是培训相关、非广告、且提供方法论层面有革新意义的创新方法，training_relevance 仍应给 4 或 5。
- 广告类内容（推销某次培训/课程报名的）应给 2 分以下，即使它推销的是培训课程。
...
字段包括：
- relevant: boolean
- training_relevance: 0 到 5（独立于 relevant，面向企业培训负责人；达到 4-5 需正文 50%+ 培训相关、非广告、且提供方法论层面有革新意义的创新方法——组织架构管理/员工培训上的可落地做法；课程招生等广告不算）
...
{{
  ...
  "training_relevance": <0 到 5，面向企业培训负责人（培训中心/HR/L&D/培训经理）。达到 4-5 需正文 50%+ 培训相关、非广告、且提供方法论层面有革新意义的创新方法（组织架构管理/员工培训上的可落地做法），而非仅引人思考。与 relevant 相互独立：即使 relevant 为 false 也可给 4 或 5>,
